...
!function (a) {
    var e = {
        ...
        placeholder: {value: "", text: "Please select country"}
    }, n = {
        AF: "Afghanistan",
        AL: "Albania",
        DZ: "Algeria",
        ...
        var g = function () {
            ...
            return a.each(o.countries, function (n, t) {
                ...
                void 0 !== o.settings.selectedCountry && o.settings.selectedCountry === n && (i = {
                    value: n,
                    selected: "selected"
                }, o.selected = {value: n, text: t}), e.append(a("<option>", i).text(t))
            ...
            var i = a("<span>").addClass("flagstrap-selected-" + s).html(t).append(e),
                r = a("<button>").attr("type", "button").attr("data-bs-toggle", "dropdown").attr("id", "flagstrap-drop-down-" + s).addClass("btn2 " + o.settings.buttonType + " " + o.settings.buttonSize + " dropdown-toggle").html(i)
