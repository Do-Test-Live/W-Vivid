!function (e) {
    ...
    }), e(".filter-menu li").on("click", function (a) {
        e(this).siblings(".is-checked").removeClass("is-checked"), e(this).addClass("is-checked"), a.preventDefault()
